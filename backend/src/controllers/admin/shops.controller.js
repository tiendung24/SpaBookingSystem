...
export async function syncImages(req, res) {
  const serviceImageMap = {
    'Nhật da + sửa form móng': 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=600&auto=format&fit=crop',
    'Tạo cấu móng': 'https://images.unsplash.com/photo-1519014816548-bf5fe059e98b?q=80&w=600&auto=format&fit=crop',
    'Úp Base': 'https://images.unsplash.com/photo-1604654894610-df63bc536371?q=80&w=600&auto=format&fit=crop',
    'Fill Gel': 'https://images.unsplash.com/photo-1516975080661-4602bb281896?q=80&w=600&auto=format&fit=crop',
    'Đắp Gel Móng Ngắn': 'https://images.unsplash.com/photo-1595868615175-10eb0a623a65?q=80&w=600&auto=format&fit=crop',
    'Đắp Gel Móng Nối': 'https://images.unsplash.com/photo-1632822453664-5fb739d4263f?q=80&w=600&auto=format&fit=crop',
    'Sơn Biab': 'https://images.unsplash.com/photo-1599839619722-39751411ea63?q=80&w=600&auto=format&fit=crop',
    'Combo Sơn Gel + Thạch': 'https://images.unsplash.com/photo-1522337660859-02fbefca4702?q=80&w=600&auto=format&fit=crop',
    'Combo Sơn Mắt Mèo + Tráng Gương': 'https://images.unsplash.com/photo-1604902396830-aca29e19b067?q=80&w=600&auto=format&fit=crop',
    'French / Ombre': 'https://images.unsplash.com/photo-1511447333015-45b65e60f6d5?q=80&w=600&auto=format&fit=crop',
    'Charm (đính đá)': 'https://images.unsplash.com/photo-1506544777-628d01198528?q=80&w=600&auto=format&fit=crop'
  };
  ...
  const staffs = await ShopStaff.find({});
  for (const st of staffs) {
    // Generate realistic avatar URL
    st.avatarUrl = `https://i.pravatar.cc/300?u=${String(st._id)}`;
    await st.save();
    staffUpdated++;
  }

  res.json({
    message: 'Hoàn tất cập nhật ảnh',
    servicesUpdated,
    staffUpdated
  });
}
