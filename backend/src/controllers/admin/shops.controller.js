...
export async function syncShopOwners(req, res) {
  const shopData = [
    { regex: /Nail Minh Hải/i, ownerName: 'Nguyễn Minh Hải (chủ shop)', avatar: 'https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-6/608951264_3785161041625842_7975474294422631319_n.jpg?stp=dst-jpg_tt6&cstp=mx2048x2048&ctp=s2048x2048&_nc_cat=101&ccb=1-7&_nc_sid=6ee11a&_nc_eui2=AeEXKpsNC-qDAHh8CQd5NTPs3O9NZpBLOLbc701mkEs4tgZf1MGk63FnI1aXsAt1C4ik8X_M6l3n890IWiKkyg0-&_nc_ohc=dJSRUiamnAsQ7kNvwFVqy4z&_nc_oc=AdpWOsRXDyv-PcanI4tI0UEwJW-iB0ZfkATK-3M0PjuGkNzXEFx4RKAVvSN3d3ofyb8&_nc_zt=23&_nc_ht=scontent.fhan18-1.fna&_nc_gid=sJDLy6PJ7xIRxgXiBZqJTg&_nc_ss=7b2a8&oh=00_Af9UXuAv1lzEhKjZIrJolnuy9rGRvO_86DxlKl4M2Cg7WQ&oe=6A360085' },
    { regex: /Nail Thu Ốc/i, ownerName: 'Thu Ốc (chủ shop)', avatar: 'https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-6/634682354_1764499854505685_1597474841185153999_n.jpg?stp=dst-jpg_tt6&cstp=mx960x960&ctp=s960x960&_nc_cat=103&ccb=1-7&_nc_sid=6ee11a&_nc_eui2=AeGjBKupvUld7Yn3jv0m8rtxQ2rrq5FUjUVDauurkVSNRX4QrpsGXNZVC6He0SgoZlPpFxgSkWZSdE_KlaFnI1vd&_nc_ohc=ZzUUJmzcz8cQ7kNvwHUAM5y&_nc_oc=Adrsuz-DYemshJZk8GlKYolzzsKoXh2Qc-IurAEDG0BhnMuSENUzikmz3mD8-hfkbhw&_nc_zt=23&_nc_ht=scontent.fhan18-1.fna&_nc_gid=r62g4de7qCXkPW7DrxLKrg&_nc_ss=7b2a8&oh=00_Af8iNueJ5LRu26WcV1jOzu0WQ3V53T5Aqcm7nExElH62gw&oe=6A35D2B8' },
    { regex: /Liên Facial/i, ownerName: 'Liên (chủ shop)', avatar: 'https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-6/713683821_1919941401991614_8508887957551539371_n.jpg?stp=cp6_dst-jpg_tt6&cstp=mx1536x2048&ctp=s1536x2048&_nc_cat=105&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeHNrxUyWZZc7XtbOJTG5S0tJe6jH94dhdYl7qMf3h2F1ns57ELL7k-B5CB0Di2htahs47S2Lft0Exim0a8Zy-vm&_nc_ohc=FGj1CdU9A0gQ7kNvwEy9gnM&_nc_oc=Adr6gLtfWTAkUDIx2tRnAwCmy8A_YkXvUnuR7JqI4v7iK_AJGkWUMTdcEnlbNSkJX0I&_nc_zt=23&_nc_ht=scontent.fhan18-1.fna&_nc_gid=J8G8fpBYBdO92bK6_MA3-w&_nc_ss=7b2a8&oh=00_Af9vVgHBC4xfDTg9i3BtMftMawawodgd7kMAMZNgIT-jgA&oe=6A35F446' },
    { regex: /Spa Thu Trang/i, ownerName: 'ThuTrang (chủ shop)', avatar: 'https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-6/603848555_2875238079336466_3618787188927211810_n.jpg?stp=dst-jpg_tt6&cstp=mx1536x2048&ctp=s1536x2048&_nc_cat=111&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeFRdID5Z7YKbMldMeP1lpPROWHZmK5XiBE5YdmYrleIEXkRilxteEaI6XyYSWxYqFNS1y8Q3Gl1FhG77SbXgqQm&_nc_ohc=M9c3mDkhcYgQ7kNvwE3pT-o&_nc_oc=AdoookUyfvwaawfPgekzEt7-5cPlAkuTF2KXub0MFAESrPreq1-wCRQyhWeZn3zcnSQ&_nc_zt=23&_nc_ht=scontent.fhan18-1.fna&_nc_gid=fw0ESTgb-o-TpQAWl-UEog&_nc_ss=7b2a8&oh=00_Af-DXfGRJY8xeQn-myV0kX0ghsCdnj2KDAjs0qRj57Zwfw&oe=6A35FB67' },
    { regex: /Ngọc Thơ/i, ownerName: 'Ngọc Thơ (chủ shop)', avatar: 'https://scontent.fhan18-1.fna.fbcdn.net/v/t39.30808-6/699891175_1660472735202742_286380561071730889_n.jpg?stp=dst-jpg_tt6&cstp=mx960x958&ctp=s960x958&_nc_cat=110&ccb=1-7&_nc_sid=6ee11a&_nc_eui2=AeGPWSiCcCgg9syR4tfB699aVYRy_OTVSxlVhHL85NVLGYkJeox5IvVHzMwL0YAwyYTQE7rKWosYNV-ygyCiamt5&_nc_ohc=QkdZ73_vC2gQ7kNvwG4ufRm&_nc_oc=AdqO_sMUnVyd94GIFDfHNR2VuKS5dGUaAGsusOSQeJ2h8IByMAXo1qgUdko4c9G_ArE&_nc_zt=23&_nc_ht=scontent.fhan18-1.fna&_nc_gid=3RGd3V6_t5Ys_bGMAcfypQ&_nc_ss=7b2a8&oh=00_Af8_yGCBHMJBCtPZxagwiasnfsH1Di4nJqDT6zbvqOnfcg&oe=6A35F09F' },
  ];

  let updated = 0;
  for (const info of shopData) {
    const shop = await Shop.findOne({ name: info.regex });
    if (!shop) continue;

    const shopId = String(shop._id);
    const existingStaffs = await ShopStaff.find({ shopId }).sort({ createdAt: 1 });

    if (existingStaffs.length > 1) {
      for (let i = 1; i < existingStaffs.length; i++) {
        await ShopStaff.findByIdAndDelete(existingStaffs[i]._id);
      }
    }

    const owner = new ShopStaff({
      shopId,
      fullName: info.ownerName,
      avatarUrl: info.avatar,
      role: 'owner',
      status: 'active',
      shortBio: 'Chủ tiệm',
      bio: 'Với nhiều năm kinh nghiệm, tôi cam kết mang lại chất lượng phục vụ tốt nhất.',
      experienceYears: 10,
      specialties: ['Quản lý', 'Chăm sóc khách hàng']
    });
    await owner.save();
    updated++;
  }

  res.json({ message: 'Hoàn tất cập nhật chủ shop', updated });
}
