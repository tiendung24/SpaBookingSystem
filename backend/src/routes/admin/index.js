...
adminRouter.get('/shops/sync-fake-booking-financials', asyncHandler(AdminShopsController.syncFakeBookingFinancials))
...
adminRouter.get('/notifications/:notificationId', asyncHandler(AdminNotificationsController.getNotificationById))
