...
const SHOP_DEF = {
  ...
  address: {
    ...
    detail: 'Spa Ngọc Thơ, Phú Hữu',
    fullAddress: 'Spa Ngọc Thơ, Phú Hữu, Thạch Hòa, Hà Nội'
  }
}
...
async function seed() {
  ...
  const shop = await Shop.create({
    ...
    description: `${SHOP_DEF.shopName} là spa/salon tại Thạch Hòa, phục vụ chăm sóc sắc đẹp và thư giãn trên LumiX.`,
    logoUrl: '',
...
seed()
  .catch((err) => {
    console.error('[seed-ngoc-tho-demo] failed', err)
    process.exitCode = 1
  })
  .finally(async () => {
