...
mongoose.connect(MONGODB_URI).then(async () => {
  try {
    ...
    let md = '# Dữ liệu Booking từ 16/06/2026 đến 21/06/2026 (Phân theo Tiệm)\n\n';
    ...
    fs.writeFileSync('c:/Users/pc/.gemini/antigravity-ide/brain/d3f221d1-cb2b-4f93-9e84-a121ce35e7fc/booking_report_full.md', md, 'utf8');
    console.log('✅ Đã tạo file báo cáo booking_report_full.md thành công. Tìm thấy ' + bookings.length + ' bookings.');
  } catch(e) {
