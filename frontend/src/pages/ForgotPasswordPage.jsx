  ...
  return (
    <div className="min-h-screen bg-white font-body-md text-main flex flex-col overflow-x-hidden bg-3d-elements">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/4 w-32 h-32 glass-card rounded-3xl opacity-30 floating-object hidden md:block" style={{ animationDelay: '-1s' }}></div>
        <div className="absolute bottom-1/3 right-1/4 w-40 h-40 glass-card rounded-full opacity-20 floating-object" style={{ animationDelay: '-3.5s' }}></div>
      </div>
      ...
      <footer className="relative z-10 w-full border-t border-gray-200 bg-gray-50 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center px-10 max-w-7xl mx-auto gap-4">
          ...
          <div className="font-body-md text-body-md text-main">
            © 2024 LumiX Partner. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
